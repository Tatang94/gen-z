-- ============================================
-- GenZ Social Media Database Schema - SQLite Version
-- Standalone SQL - Compatible with SQLite
-- ============================================
...
('andi_jakarta', 'Andi Pratama', 'andi@email.com', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face', 'Pecinta kopi dan teknologi dari Jakarta ☕', 'Jakarta, Indonesia', 1, 15420, 892, 127),

('sari_bandung', 'Sari Dewi', 'sari@email.com', 'https://images.unsplash.com/photo-1494790108755-2616b612b765?w=100&h=100&fit=crop&crop=face', 'Content creator & photographer 📸 Bandung', 'Bandung, Indonesia', 1, 12890, 567, 89),

('budi_surabaya', 'Budi Santoso', 'budi@email.com', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face', 'Entrepreneur | Startup enthusiast 🚀', 'Surabaya, Indonesia', 0, 8745, 434, 156),

('maya_yogya', 'Maya Putri', 'maya@email.com', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face', 'Art lover & culture enthusiast 🎨 Yogyakarta', 'Yogyakarta, Indonesia', 1, 22340, 1205, 203),

('rizki_bali', 'Rizki Ramadhan', 'rizki@email.com', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop&crop=face', 'Digital nomad living in paradise 🏝️', 'Bali, Indonesia', 0, 6789, 892, 78),

('admin_genz', 'GenZ Admin', 'admin@genz.com', 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=100&h=100&fit=crop&crop=face', 'Administrator akun resmi GenZ Social 👨‍💼', 'Indonesia', 1, 95420, 12, 45);
...
-- Stories with user info (active only)
...
-- ============================================
-- Triggers for Data Consistency (SQLite)
-- ============================================
...
-- SELECT 'post' as type, content, created_at FROM posts WHERE user_id = 1
-- UNION ALL
-- SELECT 'comment' as type, content, created_at FROM comments WHERE user_id = 1
...
--     p.shares,
--     p.comments_count,
--     (p.likes + p.shares + p.comments_count) as total_engagement
-- FROM posts p
-- ORDER BY total_engagement DESC;

-- ============================================
-- Database Stats Summary (SQLite)
-- ============================================
